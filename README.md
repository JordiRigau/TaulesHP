...
**La extracción no usa ningún LLM.** El PDF es texto nativo con las tablas
centradas por columna con una desviación menor de 0,2 pt, así que la posición
horizontal de cada número identifica su columna sin ambigüedad. Determinista y
exacto — donde un modelo sólo podría igualarlo y añadiría riesgo de inventarse
una cifra.
...
| Código PPL en la calculadora | ✅ funcionando en firmware 2.4.15515 |
